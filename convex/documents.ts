...
// ** Soft Delete (Can be restored from trash) -> This is a general pattern that should be used for most applications
...
export const restore = mutation({
	...
	handler: async (ctx, args) => {
		...
		if (existingDocument.parentDocumentId) {
			...
			if (parent?.isArchived) options.parentDocumentId = undefined;
		}
...
export const getById = query({
	...
	handler: async (ctx, args) => {
		...
		// ** Only allow access to published documents or documents that belong to the user
